...
export default function AboutPage() {
  return (
    <main id="main-content" className="about-page site-container">
      ...
      <section className="external-explanation"><ExternalLink aria-hidden="true" /><div><h2>Actividades en sitios externos</h2><p>Los recursos externos se abren en su plataforma original, en una pestaña nueva. Esta web no los incrusta ni depende de funciones de pago de esas plataformas.</p></div></section>
      ...
      <div className="about-cta"><p>Explora las {publicActivities.length} actividades y combina tema, idioma, tipo y plataforma.</p><Link href="/actividades" className="primary-link-button">Abrir el catálogo <ArrowRight aria-hidden="true" /></Link></div>
    </main>
  );
}
